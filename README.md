...
* **Script S3 Buckets:** To script your S3 bucket creation in your s-resources-cf.json file you can use something like the following in your `Resources` key: 
```js
  "ProjectNameS3Bucket":{
    "Type":"AWS::S3::Bucket",
    "Properties":{
      "BucketName":"bucket.name.for.the.client.${stage}.${region}"
    }
  }
```
